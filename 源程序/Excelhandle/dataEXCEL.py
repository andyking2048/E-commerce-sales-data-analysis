...
class Ui_MainWindow(QtWidgets.QWidget):
    def setupUi(self, MainWindow):
        ...
        top_layout.addWidget(self.textEdit, 4)  # 右侧区域占比较大
        ...
        self.text1.setMaximumHeight(30)  # 限制高度避免过大
        self.text1.setObjectName("text1")
        
        self.viewButton = QtWidgets.QPushButton()
        self.viewButton.setObjectName("viewButton")
        self.viewButton.setMaximumWidth(100)  # 限制按钮宽度
        self.viewButton.setMaximumHeight(30)  # 限制按钮高度
        
        path_layout.addWidget(self.text1)
        path_layout.addWidget(self.viewButton)
        
        # 添加到下半部分布局
        bottom_layout.addLayout(radio_layout, 1)  # 左侧占比较小
        bottom_layout.addLayout(path_layout, 4)   # 右侧占比较大
        
        # 将上下两部分添加到主布局
        main_layout.addLayout(top_layout, 7)      # 上半部分占比较大
        main_layout.addLayout(bottom_layout, 1)   # 下半部分占比较小
